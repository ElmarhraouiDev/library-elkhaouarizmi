						...
						<div class="box-body">
							<div class="form-group <?=form_error('id_code') ? 'has-error' : ''?>">
							 	<label for="id_code"><?=$this->lang->line('bookcategory_id_code')?></label> <span class="text-red">*</span>
							  	<input type="text" class="form-control" id="id_code" name="id_code" value="<?=set_value('id_code')?>" placeholder="Enter ID">
							  	<?=form_error('id_code')?>
							</div>
							...
							<div class="form-group <?=form_error('parent_catagory') ? 'has-error' : ''?>">
							  	...
							  	<?php 
									...
									echo form_dropdown('parent_catagory', $parent_catagory_order, set_value('parent_catagory'),'id="parent_catagory" class="form-control"');
								?>
