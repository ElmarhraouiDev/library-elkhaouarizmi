				...
				<div class="col-md-6">
					<form role="form" method="post" enctype="multipart/form-data">
						<div class="box-body">
							...
							<div class="form-group <?=form_error('booktypeID') ? 'has-error' : ''?>"></label> <span class="text-red">*</span>
							  	<label for="booktypeID"><?=$this->lang->line('book_booktype')?></label>
								<?php 
									$booktypeArray 		= [];
									$booktypeArray[0]	= $this->lang->line('book_please_select');
									...
									echo form_dropdown('booktypeID', $booktypeArray, set_value('booktypeID', $book->booktypeID), 'id="booktypeID" class="form-control"');
								?>
							...
							<div class="form-group <?=form_error('volume') ? 'has-error' : ''?>">
							 	<label for="volume"><?=$this->lang->line('book_volume')?></label> <span class="text-red"></span>
							  	<input type="number" class="form-control" id="volume" name="volume" value="<?=set_value('volume', $book->volume)?>" placeholder="Enter Volume">
							  	<?=form_error('volume')?>
							</div>
							...
							<div class="form-group <?=form_error('bookcategoryID') ? 'has-error' : ''?>">
								...
								<?php 
									...
									$parent_catagory_order[0] = $this->lang->line('book_please_select');
									$parent_catagory_order = array_reverse($parent_catagory_order, true);
									echo form_dropdown('bookcategoryID[]', $parent_catagory_order, set_value('bookcategoryID', $book->bookcategoryID[1]), 'id="bookcategoryID" class="form-control"');
								?>
