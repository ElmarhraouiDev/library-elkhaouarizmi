						...
						<div class="box-body">
							<div class="form-group <?=form_error('firstname') ? 'has-error' : ''?>">
							 	<label for="firstname"><?=$this->lang->line('member_firstname')?></label> <span class="text-red">*</span>
							  	<input type="text" class="form-control" id="firstname" name="firstname" value="<?=set_value('firstname', $member->firstname)?>" placeholder="Enter firstname">
							...
							<div class="form-group <?=form_error('lastname') ? 'has-error' : ''?>">
							 	<label for="lastname"><?=$this->lang->line('member_lastname')?></label> <span class="text-red">*</span>
							  	<input type="text" class="form-control" id="lastname" name="lastname" value="<?=set_value('lastname', $member->lastname)?>" placeholder="Enter lastname">
							  	<?=form_error('lastname')?>
							</div>
							...
							<div class="form-group <?=form_error('classeID') ? 'has-error' : ''?>">
								...
								<?php 
									...
									echo form_dropdown('classeID', $classeArray,set_value('classeID', $member->classeID),'id="classeID" class="form-control"');
								?>
								<?=form_error('classeID')?>
							</div>
							<div style="display:none" class="form-group <?=form_error('class_group') ? 'has-error' : ''?>">
								  ...
								  <?php 
									...
									echo form_dropdown('class_group', $class_groupArray, set_value('class_group', $member->class_group),'id="class_group" class="form-control"');
								?>							  	
