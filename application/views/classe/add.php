    ...
    <section class="content-header">
  		...
  		<ol class="breadcrumb">
            <li><a href="<?=base_url('dashboard')?>"><i class="fa fa-dashboard"></i><?=$this->lang->line('dashboard')?></a></li>
  			<li><a href="<?=base_url('division')?>"><?=$this->lang->line('classe')?></a></li>
                    ...
                    <form classe="form" method="POST">
                        <div class="box-body">
                            <div class="form-group <?=form_error('classe') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" value="<?=set_value('classe')?>" id="classe" name="classe"/>
                                <?=form_error('classe')?>
                            </div>
                        </div>
                        <div class="box-footer">
                            <button type="submit" class="btn btn-mytheme"><?=$this->lang->line('classe_add_classe')?></button>
                        </div>
                    </form>
                </div>
            </div>
